# adzuna_api.py - Module for communicating with the Adzuna API
import os
import logging
import requests
...
if __name__ == "__main__":
  ...
  # Test the API
  try:
    jobs = search_jobs(keywords="python developer", location="London", country="gb", page=1, results_per_page=10)
