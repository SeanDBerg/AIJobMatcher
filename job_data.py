...
# Path to the sample job data file
JOB_DATA_FILE = os.path.join(os.path.dirname(__file__), 'static', 'job_data', 'sample_jobs.json')
...
def load_job_data():
    ...
    Returns:
        List of Job objects
    """
    logger.debug(f"Loading job data from {JOB_DATA_FILE}")
    ...
    try:
        ...
        logger.warning(f"Job data file not found at {JOB_DATA_FILE}")
        # Create directory if it doesn't exist
        os.makedirs(os.path.dirname(JOB_DATA_FILE), exist_ok=True)
