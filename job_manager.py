...
class JobManager:
  ...
  def get_storage_status(self) -> Dict[str, Any]:
    ...
    status = {"batch_count": batch_count, "total_jobs": job_count, "last_sync": last_sync, "last_batch": last_batch, "batches": index["batches"]}
  ...
  def search_jobs(self, keywords: Optional[str] = None, location: Optional[str] = None, country: str = "gb", distance: int = 15, max_days_old: int = 30, page: int = 1, results_per_page: int = 50, category: Optional[str] = None, full_time: Optional[bool] = None, permanent: Optional[bool] = None) -> tuple:
    """
    ...
    # Store the jobs
    if jobs:
      self.store_jobs(jobs, keywords=keywords, location=location, country=country, max_days_old=max_days_old)
